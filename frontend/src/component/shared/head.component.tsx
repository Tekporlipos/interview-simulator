...
export default function HeadComponent(props: any) {
  ...
  useEffect(() => {
    window.addEventListener("scroll", (e) => {
      setVisible(props?.state && window.scrollY > 500);
    });
  }, []);
  return (
    <div
      className={`${
        !props?.state || visible ? "shadow-xl" : ""
      } transition z-10  bg-white top-0 left-0 right-0 bg-fixed fixed px-5 w-full`}
    >
      <div className="text-center flex flex-row justify-between items-center container">
        ...
        <div className="nav">
          <svg
            ...
            height="32"
            onClick={setClick}
            className="block md:hidden a"
            viewBox="0 0 24 24"
          >
            <title>menu</title>
            <path d="M3,6H21V8H3V6M3,11H21V13H3V11M3,16H21V18H3V16Z" />
          </svg>
          <ul className="list-none flex-row justify-between items-center mt-2 hidden md:flex">

            <div className="ms-5">
              <div className="flex a hover:underline transition">
              ...
              <ul className="absolute bg-white shadow hidden p-5  pt-6 w-1/6 flex-col font-weight-300 mx-3">
                <Link
                    href="#"
                    className=" flex justify-between hover:underline transition"
                >
                ...
                <Link
                    href="#"
                    className="mt-4 flex justify-between hover:underline transition"
                >
            ...
            <div className="ms-5">
              ...
              <ul className="absolute bg-white shadow hidden p-5  pt-6 w-1/6 flex-col font-weight-300 mx-3">
                ...
                <Link
                    href="#"
                    className="mt-2 flex justify-between hover:underline transition"
                >
            ...
            <div className="ms-5 a hover:underline transition">
              <div className="flex">
                <div>Resources</div>
                <svg width="24" height="24" viewBox="0 0 24 24">
                  <title>menu-down</title>
              ...
              <ul className="transition absolute hidden bg-white shadow p-5  pt-6 w-1/6 flex-col font-weight-300 mx-3">
                <Link
                    href="resources/report"
                    className="flex justify-between transition hover:underline"
                >
                ...
                <Link
                    href="resources/activity"
                    className="mt-4 flex justify-between transition hover:underline"
                >
                  <div>Activities</div>
                  <svg width="24" height="24" viewBox="0 0 24 24">
      ...
      <div className="hidden mobile-menu flex-col uppercase font-weight-300 md:hidden">


        <div className="mt-5 a">
          <div className="hover:underline transition flex justify-between">
            <div>For Recruiters</div>
            <svg width="24" height="24" viewBox="0 0 24 24">
              <title>menu-down</title>
              <path d="M7,10L12,15L17,10H7Z"/>
          ...
          <ul className="hidden flex-col  font-weight-200 text-xs mx-3">
        ...
        <div className="mt-5 a">
          ...
          <ul className="hidden flex-col font-weight-200 text-xs mx-3">
            <Link href="resources/report" className="mt-4 flex justify-between">
              <div>Interview Reports</div>
            ...
            <Link href="resources/activity" className="mt-4 flex justify-between">
              <div>Activities</div>
              <svg width="16" height="16" viewBox="0 0 24 24">
                <title>clipboard-text-clock-outline</title>
                <path
        ...
        <Link
            href="/booking"
            className="mt-5 w-full bg-red-500 text-center text-white font-weight-200 transition py-2 hover:bg-red-600 rounded-lg"
        >
          Mock Interview
        </Link>
