...
export default function CreatorPageComponent(props: any) {
        ...
        <div className="col-12 row mt-5">
          ...
          <div className="flex-column col-md-6 col-sm-12">
            <div className="bg-secondary rounded  p-3 text-black text-center font-weight-300 shadow-lg mb-5">
              Feel free to fill in the fields you prefer, but remember, the more
              details you offer, the more accurate and personalized your
              enhanced CV will become. If you&apos;re short on time, no worries
              – GenieAI will step in to provide thoughtful suggestions!
            </div>
            <div className="logo justify-content-center">
              <button
                className="btn btn-outline-danger text-white text-uppercase logo"
                onClick={() => props.send()}
              >
                <div className="ms-1">Preview</div>
                <svg
                  width="24"
                  height="24"
                  fill="none"
