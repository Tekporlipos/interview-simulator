...
export const metadata: Metadata = {
  title: "Interview Simulator - Interview",
  ...
  openGraph: {
    ...
    description:
      "Interview simulation is a valuable tool offered by InterviewSimulator, providing individuals and professionals with a realistic and immersive practice environment. Using advanced algorithms and an intuitive chat-based interface, our platform replicates real-world interview scenarios to help users refine their skills.",
