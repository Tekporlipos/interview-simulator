              ...
              <div className="px-8 py-4">
                ...
                <div className="flex flex-col">
                  ...
                  <div className="font-weight-300 text-sm">
                    Heroes, feature sections, newsletter sign up forms — all of
                    the components you need to build beautiful marketing
                    websites.
                  </div>
                </div>
              </div>
          ...
          <div className="flex-1 border p-8 rounded-xl border-red-500/5 bg-red-500/5 shadow">
            ...
            <div className="flex gap-5 mb-5">
              ...
              <div className="font-weight-300">
                <span className="font-weight-500">Over 500+ components —</span>{" "}
